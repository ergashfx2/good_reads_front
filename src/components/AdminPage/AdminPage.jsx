...
function AdminPage(props) {
  ...
  const handleSearch = async (e) => {
    let filteredName = userData.users.filter((obj) =>
      obj.name.toLowerCase().includes(e.target.value.toLowerCase())
    );
    let filteredId = userData.users.filter((obj) =>
      obj.id.toLowerCase().includes(e.target.value.toLowerCase())
    );
    let filteredEmail = userData.users.filter((obj) =>
      obj.email.toLowerCase().includes(e.target.value.toLowerCase())
    );
